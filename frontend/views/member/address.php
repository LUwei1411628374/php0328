		...
		<div class="content fl ml10">
			<div class="address_hd">
                ...
                <?php foreach($address as $addres):?>
                    <dl>
                        <dt><?=$addres->name?> <?=$addres->city?> <?=$addres->address?> <?=$addres->tel?> </dt>
                        <dd>
                            <a href="/member/add-edit?id=<?=$addres->id?>">修改</a>
                            <a href="/member/add-del?id=<?=$addres->id?>">删除</a>
                            <a href="/member/add-status?id=<?=$addres->id?>">设为默认地址</a>
                        </dd>
                    </dl>
                <?php endforeach;?>
