...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['member/login'])?>">登录</a>] [<a href="<?=\yii\helpers\Url::to(['member/regist'])?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?=$models->name?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="http://admin.yii2shop.com<?=$pics['0']->path?>" class="jqzoom" rel="gal1" style="height:350px;width:350px">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.yii2shop.com<?=$pics['0']->path?>" alt="" style="height:350px;width:350px"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.yii2shop.com<?=$pic->path?>',largeimage: 'http://admin.yii2shop.com<?=$pic->path?>'}"><img src="http://admin.yii2shop.com<?=$pic->path?>" ></a>
								</li>
                            <?php endforeach;?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=date('Y-m-d',$models->create_time)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to(['site/add-cart'])?>" method="get" class="choose">
						<ul>
