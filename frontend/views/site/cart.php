...
<body>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="<?=\yii\helpers\Url::to(['member/index'])?>"><img src="<?=Yii::getAlias('@web')?>/images/logo.png" alt="京西商城"></a></h2>
			<div class="flow fr">
				<ul>
	...
	<!-- 主体部分 start -->
	<div class="mycart w990 mt10 bc" id="shop">
		...
		<table>
			...
			<tbody>
				...
				<tr data-id="<?=$model['id']?>">
					<td class="col1"><a href=""><img src="http://admin.yii2shop.com<?=$model['logo']?>" alt="" /></a>  <strong><a href=""><?=$model['name']?></a></strong></td>
...
<script type="text/javascript">
    $(function () {
       var shops= $("#shop tbody tr .col5 span");
       console.debug(shops);
        var result=0;
       shops.each(function (i,obj) {
            result+=Number($(obj).text());
       });
        console.log(result);
        var total=$('#total');
        total.text(result+'.00')
    })
